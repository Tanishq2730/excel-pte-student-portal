export const all_routes = {
  ...
  summarizeSpokenText:"/summarize-spoken-text/:subtype_id/:question_id?",
  multipleChooseAnswerListen:"/multiple-choose-answered/:subtype_id/:question_id?",
  fillInTheBlanks:"/fib/:subtype_id/:question_id?",
  highlightCorrectSummary:"/highlight-correct-summary/:subtype_id/:question_id?",
  multipleChooseSingleAnswerListen:"/multiple-choose-single-answer-listen/:subtype_id/:question_id?",
  selectMissingWord:"/select-missing-word/:subtype_id/:question_id?",
  highlightIncorrectWord:"/highlight-incorrect-word/:subtype_id/:question_id?",
  writeFromDictation:"/write-from-dictation/:subtype_id/:question_id?",
