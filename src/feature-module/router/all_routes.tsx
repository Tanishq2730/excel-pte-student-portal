export const all_routes = {
  ...
  summarizeWritinText:"/summarize-written-text",
  writeEssay:"/write-essay",
  readingWritngFillBlank:"/reading-&-writng-fb",
  multipleChooseAnswer:"/multiple-choose-answer",
  multipleChooseSingleAnswer:"/multiple-choose-Single-answer",
  summarizeSpokenText:"/summarize-spoken-text",
  multipleChooseAnswerListen:"/multiple-choose-answered",
  fillInTheBlanks:"/fib",
  highlightCorrectSummary:"/highlight-correct-summary",
  multipleChooseSingleAnswerListen:"/multiple-choose-single-answer-listen",
