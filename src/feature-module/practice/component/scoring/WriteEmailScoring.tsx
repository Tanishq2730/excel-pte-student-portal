...
const WriteEmailScoring = async (scoringData: any, questionData: any, selectedLanguage: string) => {
    if (!scoringData) {
    ...
    try {
        ...
        console.error("Error in trying to store the WriteEmailScoring data: ", error);
      }
