...
const MultipleChooseSingleAnswer: React.FC<getProps> = ({ question, setAnswer, registerSubmit,setCountdownDone }) => {
        ...
        {options.map((option) => (
          <div key={option.id} className="col-12 col-md-12">
            <div className="d-flex align-items-start border rounded p-3 h-100">
              ...
              />
              <label htmlFor={`option-${option.id}`} className="d-flex align-items-center w-100">
                <div
